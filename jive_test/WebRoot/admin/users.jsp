...
<tr>
<%  if (start > 0) { %>
	<td width="1%" nowrap><font size="-1"><a href="users.jsp?start=<%= start-range %>">Previous <%= range %> users</a></font></td>
<%  } else { %>
...
<%  if (start+range < userCount) { %>
	<td width="1%" nowrap><font size="-1"><a href="users.jsp?start=<%= start+range %>">Next <%= range %> users</a></font></td>
<%  } else { %>
	<td width="1%" nowrap><font size="-1">&nbsp;</font></td>
<%  } %>
</tr>

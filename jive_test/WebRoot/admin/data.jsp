...
%>
    ...
    <tr><td bgcolor="#eeeeee" align="center"><font size="-2" face="verdana">&nbsp;</font></td>
        <td bgcolor="#eeeeee" align="center"><font size="-2" face="verdana"><b>&nbsp;FILENAME&nbsp;</b></font></td>
        <td bgcolor="#eeeeee" align="center"><font size="-2" face="verdana"><b>&nbsp;SIZE&nbsp;</b></font></td>
        <td bgcolor="#eeeeee" align="center"><font size="-2" face="verdana"><b>&nbsp;LAST MODIFIED&nbsp;</b></font></td>
    </tr>
    ...
    %>
        <tr bgcolor="#ffffff">
            <td><input type="radio" name="file" value="<%= StringUtils.encodeHex(fname.getBytes()) %>" id="<%= i %>"></td>
            <td><font size="-1">
                &nbsp;<label for="<%= i %>"><%= fname %></label>&nbsp;
                </font>
            </td>
            <td><font size="-1">
                &nbsp;<%= filesize %>&nbsp;
    ...
    <tr>
    	...
    	<td>
            ...
            <tt><%= JiveGlobals.getJiveHome() + File.separator %>data<%= File.separator + exporter.getFilename() %></tt>
            </font>
        </td>
    </tr>
    <tr>
    	...
    	<td>
            ...
            <tr>
            	<td colspan="3">
                    ...
                    <input type="text" name="customFilename" value="<%= exporter.getFilename() %>" size="30" maxlength="50"
                     onclick="this.form.type[this.form.type.length-1].checked=true;">

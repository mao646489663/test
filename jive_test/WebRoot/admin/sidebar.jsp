...
<%  } else if (isSystemAdmin && "system".equals(sidebar)) { %>
    ...
    <%  if (isPro || isEnt) { %>
        ...
        <tr>
            <td class="bullet">&#149;</td>
            <td><a href="readTracking.jsp" target="main">Read Tracking Settings</a></td>
        </tr>
        --%>
    <%  } %>
    <tr>
        <td class="bullet">&#149;</td>
        <td><a href="edit-policy.jsp" target="main">Message Editing Policy</a></td>
    </tr>
    <tr>
        <td class="bullet">&#149;</td>
    ...
    <tr>
        <td class="bullet">&#149;</td>
        <td><a href="manageRewards.jsp" target="main">Manage Reward Points</a></td>
    </tr>
    <tr>
        <td class="bullet">&#149;</td>
...
<%  }
    else if ((isSystemAdmin || isCatAdmin || isForumAdmin || isModerator) && "forum".equals(sidebar)) {
        ...
        if (forum != null) {
            isAdmin = forum.isAuthorized(Permissions.SYSTEM_ADMIN | ForumPermissions.FORUM_CATEGORY_ADMIN | ForumPermissions.FORUM_ADMIN);
        }
%>
    <table class="sidebar-group" cellpadding="3" cellspacing="0" border="0" width="100%">
    <tr>
...
<%  } else if ((isSystemAdmin || isForumAdmin || isCatAdmin || isModerator) && "moderation".equals(sidebar)) { %>

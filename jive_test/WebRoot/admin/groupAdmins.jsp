...
<font size="-1"><b>Add Admins to this Group</b></font><p>
...
<ul>
    ...
    <tr><td><input type="submit" value="Add Admins To Group"></td></tr>
    </table>
</ul>
</form>
<p>

<font size="-1"><b>Current Group Admins</b></font><p>
<ul>
...
%>
<tr bgcolor="#ffffff">
    <td><font size="-1"><%= admin.getUsername() %></font></td>
    <td><font size="-1">&nbsp;<%= (name!=null)?name:"&nbsp;" %>&nbsp;</font></td>
    <td align="center"><a href="groupAdmins.jsp?group=<%= groupID %>&remove=true&member=<%= admin.getID() %>"

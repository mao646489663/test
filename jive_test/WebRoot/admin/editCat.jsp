...
<ul>
    ...
    <tr bgcolor="#ffffff">
        ...
        <td align="center"><font size="-1">&nbsp;<%= SkinUtils.formatDate(request,pageUser,category.getCreationDate()) %>&nbsp;</font></td>
        <td align="center"><font size="-1">&nbsp;<%= SkinUtils.formatDate(request,pageUser,category.getModificationDate()) %>&nbsp;</font></td>
    </tr>
    </table>
    </td></tr>
    </table>

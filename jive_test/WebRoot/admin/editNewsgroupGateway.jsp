...
<ul>
    ...
    <tr>
    	...
    	<td><input type="text" name="host" value="<% if (host != null) { %><%= host %><% } %>" size="30" maxlength="100" tabIndex="<%= tabIndex++ %>"></td>
        <td><a href="#" onclick="helpwin('newsGateway','host');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
    	<td><font size="-1">Newsgroup:</font></td>
    	<td><input type="text" name="newsgroup" value="<% if (newsgroup != null) { %><%= newsgroup %><% } %>" size="30" maxlength="100" tabIndex="<%= tabIndex++ %>"></td>
        <td><a href="#" onclick="helpwin('newsGateway','newsgroup');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    </table>
</ul>
<% if (!importOnce) { %>
...
<ul>
    ...
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','defaultfrom');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    </table>
</ul>
<% } %>
...
<ul>
    ...
    <tr>
        ...
        <td><input type="text" name="port" value="<%= port %>" size="3" maxlength="5" tabIndex="<%= tabIndex++ %>"></td>
        <td><a href="#" onclick="helpwin('newsGateway','port');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
        <td><font size="-1">NNTP server username: </font></td>
        <td><input type="text" name="username" value="<% if (username != null) { %><%= username %><% } %>" size="15" maxlength="100" tabIndex="<%= tabIndex++ %>"></td>
        <td><a href="#" onclick="helpwin('newsGateway','username');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
        <td><font size="-1">NNTP server password: </font></td>
        <td><input type="text" name="password" value="<% if (password != null) { %><%= password %><% } %>" size="15" maxlength="100" tabIndex="<%= tabIndex++ %>"></td>
        <td><a href="#" onclick="helpwin('newsGateway','password');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','debug');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
    	<td><font size="-1">Allow import/export<br>of attachments:</font></td>
    	<td><font size="-1"><input type="radio" name="attachments" value="true" <% if (attachments) { %>checked<% } %> tabIndex="<%= tabIndex++ %>">Enabled <input type="radio" name="attachments" value="false" <% if (!attachments) { %>checked<% } %>>Disabled</font></td>
        <td><a href="#" onclick="helpwin('newsGateway','attachments');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    </table>
</ul>
<% if (!exportOnce) { %>
...
<ul>
    ...
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','subjectcheck');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','tempparent');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <% if (importOnce) { %>
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','importafter');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <% } %>
    </table>
</ul>
...
<ul>
    ...
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','organization');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','honouremail');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <% if (exportOnce) { %>
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','exportafter');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','allowexportagain');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <tr>
        ...
        <td><a href="#" onclick="helpwin('newsGateway','updatemessageid');return false;" title="Click for help"><img src="images/help-16x16.gif" width="16" height="16" border="0" hspace="8"></a></td>
    </tr>
    <% } %>
    </table>
</ul>

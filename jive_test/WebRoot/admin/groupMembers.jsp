...
<font size="-1"><b>Add Members to this Group</b></font><p>
...
<ul>
    ...
    <tr><td><textarea name="userList" cols="30" rows="2"></textarea></td></tr>
    <tr><td><input type="submit" value="Add Users To Group"></td></tr>
    </table>
</ul>
</form>
<p>
...
<font size="-1"><b>Members of this group (<%= memberCount %>)</b></font><p>
<ul>
    ...
    <tr bgcolor="#eeeeee">
        ...
        <td align="center" nowrap><font size="-2" face="verdana"><b>USERNAME</b></font><img src="images/down.gif" width="8" height="7" border="0" hspace="4"></td>
        <td align="center" nowrap><font size="-2" face="verdana"><b>NAME</b></font></td>
        <td align="center" nowrap><font size="-2" face="verdana">&nbsp;<b>TOPICS &amp;&nbsp;<br>&nbsp;WATCHES</b>&nbsp;</font></td>
    ...
    <tr bgcolor="#ffffff">
        ...
        <td width="1%" nowrap><font size="-1"><a href="editUser.jsp?user=<%= member.getID() %>"><%= member.getUsername() %></a></font></td>
        <td width="96%"><font size="-1">&nbsp;<%= (name!=null)?name:"&nbsp;" %>&nbsp;&nbsp;&nbsp;</font></td>

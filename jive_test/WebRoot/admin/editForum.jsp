...
<%	// Permission check
    ...
    if (saveName) {
        ...
        setOneTimeMessage(session,"editForum.message","Changes saved.");
...
<ul>
    ...
    <tr bgcolor="#ffffff">
        <td align="center" bgcolor="#eeeeee"><font size="-1"><%= forum.getID() %></font></td>
        <td align="center"><font size="-1"><%= forum.getThreadCount() %></font></td>
        <td align="center"><font size="-1"><%= forum.getMessageCount() %></font></td>
        <td align="center"><font size="-1">&nbsp;<%= SkinUtils.formatDate(request,pageUser,forum.getCreationDate()) %>&nbsp;</font></td>
        <td align="center"><font size="-1">&nbsp;<%= SkinUtils.formatDate(request,pageUser,forum.getModificationDate()) %>&nbsp;</font></td>
    </tr>
    </table>
    </td></tr>
    </table>
...
<ul>
    ...
    <p>
    <%  String message = getOneTimeMessage(session,"editForum.message");
        if (message != null) {
    %>

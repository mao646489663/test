...
<font size="-1">
Edit attachment policies using the forms below. The enabling/disabling of attachments is permission
based. So, if you wish to completely turn off attachments, remove all attachment permissions.
</font>
<p>
...
<font size="-1"><b>General Attachment Settings</b></font><p>
<ul>
    ...
    <tr>
        ...
        <td><input type="text" size="10" maxlength="15" name="maxThumbDimension" value="<%= maxThumbDimension %>"></font></td>
...
<ul>
    ...
    <tr>
        ...
        <td><label for="rb11"><font size="-1">Disallow all content types except those listed below.</font></label></td>
    ...
    <tr bgcolor="#eeeeee">
        <td align="center"><font size="-2" face="verdana"><b><%= (allow)?"DISALLOWED":"ALLOWED" %> CONTENT TYPES</b></font></td>
    ...
    <tr bgcolor="#ffffff">
        <td valign="top">
            ...
            <%  } %>
            <%  if (hadNext) { %>
            </select><br><center><input type="submit" name="submitButton" value="Remove"></center>
            <%  } else { %>
            </select>
            <%  } %>
            </font>

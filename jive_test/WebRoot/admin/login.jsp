...
<%! // Global methods/vars, etc
    ...
    private boolean isSystemAdmin(AuthToken authToken) {
        ForumFactory forumFactory = ForumFactory.getInstance(authToken);
        return forumFactory.isAuthorized(Permissions.SYSTEM_ADMIN);
    }
%>
...
<%	// get parameters
    ...
    if ("true".equals(JiveGlobals.getJiveProperty("admin.tryAlternativeLogin"))) {
        ...
        try {
            ...
            if (Version.getEdition() == Version.Edition.LITE && !isSystemAdmin(authToken)) {
                // not allowed
            }

...
<%	// Security check
    ...
    if (isDisabled) {
        throw new Exception("User and group admin has been disabled.");
    }
...
<tr bgcolor="#eeeeee">
    ...
    <td align="center" nowrap><font size="-2" face="verdana"><b>GROUP NAME</b></font><img src="images/down.gif" width="8" height="7" border="0" hspace="4"></td>
...
%>
<tr bgcolor="#ffffff">
    <td align="center" width="1%"><font size="-1"><%= group.getID() %></font></td>
    <td width="<%= (isSystemAdmin)?"96":"97" %>%"><font size="-1"><a href="editGroup.jsp?group=<%= group.getID() %>"><%= group.getName() %></a><br></font><font size="-2"><%= group.getDescription() %></font></td>
    <td width="1%" align="center"><font size="-1"><%= group.getMemberCount() %></font></td>
...
<tr>
<%  if (start > 0) { %>
	<td width="1%" nowrap><font size="-1"><a href="groups.jsp?start=<%= start-range %>">Previous <%= range %> groups</a></font></td>
<%  } else { %>
...
<%  if (start+range < groupCount) { %>
	<td width="1%" nowrap><font size="-1"><a href="groups.jsp?start=<%= start+range %>">Next <%= range %> groups</a></font></td>
<%  } else { %>
	<td width="1%" nowrap><font size="-1">&nbsp;</font></td>
<%  } %>
</tr>

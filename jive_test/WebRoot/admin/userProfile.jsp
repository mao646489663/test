...
<font size="-1">
Profile for user <b><%= user.getUsername() %></b>:
<%  if (isSystemAdmin) { %>
...
<tr><td bgcolor="#ffffff" width="1%" nowrap><img src="images/blank.gif" width="25" height="1" border="0"></td>
<td width="99%">
<table bgcolor="<%= tblBorderColor %>" cellpadding="3" cellspacing="1" border="0" width="100%">
<tr bgcolor="#ffffff">
    <td width="25%"><font size="-1">User ID:</font></td>
    <td width="75%"><font size="-1"><%= user.getID() %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td width="25%"><font size="-1">Name:</font></td>
    <td width="75%"><font size="-1"><%= (name!=null)?name:"<i>Not Set</i>" %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td width="25%"><font size="-1">Email Address:</font></td>
    <td width="75%"><font size="-1"><% if (email != null) { %><a href="mailto:<%= email %>"><%= email %></a><% } else { %>&nbsp;<% } %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td width="25%"><font size="-1">Account Created:</font></td>
    <td width="75%"><font size="-1"><%= SkinUtils.formatDate(request,pageUser,creationDate) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td width="25%"><font size="-1">Last Updated:</font></td>
    <td width="75%"><font size="-1"><%= SkinUtils.formatDate(request,pageUser,modifiedDate) %></font></td>
</tr>
<tr bgcolor="#ffffff">
    <td width="25%"><font size="-1">Number of Posts:</font></td>
    <td width="75%"><font size="-1"><%= numPosts %></font></td>
</tr>
</table>
</td></tr>
</table>
...
<%  if (isSystemAdmin || isUserAdmin ) { %>
    <font size="-1">
    Extended Properties for <b><%= user.getUsername() %></b>:
    </font>
    <p>
    <%  // Extended properties
    ...
    %>
    <tr bgcolor="#ffffff">
        <td width="25%"><font size="-1"><%= propertyName %></font></td>
        <td width="74%"><font size="-1"><%= propertyValue %></font></td>

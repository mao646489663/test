...
<ul>
    <font size="-1">Export all available messages to an existing gateway.</font><p>
...
%>
    <tr bgcolor="#ffffff">
        ...
        <%  if (isEmailGateway) { %>
            ...
            ><img src="images/button_edit.gif" width="17" height="17" alt="Export using this gateway" border="0"
            ></a>
        <%  } else if (isNewsgroupGateway) { %>
...
<ul>
    <font size="-1">Export all available messages from this forum to a new gateway.</font><p>
    ...
    <tr>
    	...
    	<td><font size="-1"><label for="rb04">Email Gateway -- export all messages to an email account or mailing list.</label></font></td>
    </tr>
    <tr>
    	...
    	<td><font size="-1"><label for="rb06">Newsgroup Gateway -- export all messages to a NNTP newsgroup.</label></font></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
        <td colspan="2"><input type="submit" name="submitButton" value="Export"> <input type="submit" name="submitButton" value="Cancel"></td>
    </tr>
    </table>
    </form>
</ul>

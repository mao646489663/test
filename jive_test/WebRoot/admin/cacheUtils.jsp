...
<%@ page import="java.util.*,
                 ...
                 com.jivesoftware.base.database.DbPermissionsManager"
%>
...
<%  // Get a db forum factory instance:
    ...
    com.jivesoftware.util.Cache[] caches = null;
    String[] names = null;
    ...
    if (cacheManager.isShortTermQueryCacheEnabled() && Version.EDITION == Version.Edition.ENTERPRISE) {
        ...
        cachePresetSizes = new int[][] {
            ...
            {  128*1024,  256*1024,   512*1024 },  /* Reward Cache */
            {  128*1024,  256*1024,  1024*1024 },  /* Read Tracker Cache */
            {  128*1024,  256*1024,   512*1024 }   /* Watches */
        };
        // Get a list of caches:
        caches = new com.jivesoftware.util.Cache[] {

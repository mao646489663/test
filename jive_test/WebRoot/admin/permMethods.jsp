...
<%! // Global vars, methods, etc
    ...
    /**
     * Returns a list of categories where the user has the given privilege type.
     * If the user doesn't have the given privilege on at least 1 category, a
     * list of size zero is returned.
     */
                    ...
                    || forum.isAuthorized(ForumPermissions.MODERATOR))
            {
                if (!moderationEnabled) {
                    ...
                    boolean isThreadModOn = (
                        forum.getModerationDefaultThreadValue() < JiveConstants.FORUM_MODERATION_VISIBLE
                    );

...
<%  } else { %>
    ...
    <table class="jive-list" cellpadding="3" cellspacing="0" border="0" width="100%">
    <tr>
    ...
    %>
        ...
        <%  } %>
            ...
            <td width="98%">
                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                <tr valign="top">
                    <td width="1%"><img src="images/blank.gif" width="<%= (treeWalker.getMessageDepth(msg)*15) %>" height="1" border="0"></td>
                    <td width="1%" class="jive-bullet">

                        <%  if (action.getReadStatus(msg, ReadTracker.UNREAD)) { %>

                            <img src="images/unread.gif" width="9" height="9" border="0" vspace="4" hspace="2">

                        <%  } else if (action.getReadStatus(msg, ReadTracker.UPDATED)) { %>
                    ...
                    <td width="98%">
                        <a href="message.jspa?messageID=<%= msg.getID() %>"
                         ><%= msg.getSubject() %></a>
                    </td>
                </tr>
                </table>
            ...
            <td width="1%" nowrap>
                ...
                <%  if (msg.getUser() != null) { %>
                    ...
                    <a href="profile.jspa?userID=<%= msg.getUser().getID() %>"

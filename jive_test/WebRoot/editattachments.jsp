...
<ww:else>
    ...
    <div class="jive-edit-attach-list">

    <table class="jive-box" cellpadding="3" cellspacing="0" border="0">
    <tr>
        <th colspan="3">
            <%-- Filename --%>
    ...
    <ww:iterator value="message/attachments" status="'status'">
        ...
        <tr class="<ww:if test="@status/odd==true">jive-odd</ww:if><ww:else>jive-even</ww:else>">
            ...
            <td>
                <img src="servlet/JiveServlet?attachImage=true&contentType=<ww:property value="contentType" />&attachment=<ww:property value="ID" />" border="0">
            </td>
            <td>
                <a href="servlet/JiveServlet/download/<ww:property value="$forumID" />-<ww:property value="$threadID" />-<ww:property value="$messageID" />-<ww:property value="ID" />/<ww:property value="name" />"
    ...
    <ww:if test="@counter/current <= attachmentManager/maxAttachmentsPerMessage">
        ...
        <form action="editattach!execute.jspa?forumID=<ww:property value="$forumID" /><ww:if test="$threadID">&threadID=<ww:property value="$threadID" /></ww:if><ww:if test="$messageID">&messageID=<ww:property value="$messageID" /></ww:if>"

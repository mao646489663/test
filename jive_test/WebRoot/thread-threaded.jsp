...
<%  // Get the action and other variables for this view.
    ...
    ForumFactory forumFactory = action.getForumFactory(); // needed by included pages
...
<tr valign="top">
    <td width="98%">
        ...
        <%-- Pages: [page count] (note, in the threaded view there is *always* only 1 page) --%>
        <jive:i18n key="global.pages" /><jive:i18n key="global.colon" /> 1 &nbsp;
